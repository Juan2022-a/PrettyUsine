...
const SAVE_FORM = document.getElementById('saveForm'),
    ...
    CORREO_CORRESPONDIENTE = document.getElementById('correoCliente'),
    TELFONO_CORRESPONDIENTE = document.getElementById('telefonoCliente'),
    ESTADO_CLIENTE = document.getElementById('estadoClientes');
...
SAVE_FORM.addEventListener('submit', async (event) => {
    ...
    (NOMBRE_CLIENTE.value) ? action = 'updateRow' : action = 'createRow';
    // Constante tipo objeto con los datos del formulario.
...
const fillTable = async (form = null) => {
    ...
    if (DATA.status) {
        ...
        DATA.dataset.forEach(row => {
            ...
            TABLE_BODY.innerHTML += `
                <tr>
                    <td><img src="${SERVER_URL}images/categorias/${row.nombre_cliente}" height="50"></td>
