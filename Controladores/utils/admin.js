...
document.querySelector('title').textContent = 'PrettyUsine - Dashboard';
                ...
                <footer>
                    <nav class="navbar fixed-bottom bg-body-tertiary">
                        <div class="container">
                            ...
                            <div>               
                                <p><a class="nav-link" href="../../Publica/" target="_blank"><i class="bi bi-cart-fill"></i> Sitio público</a></p>
